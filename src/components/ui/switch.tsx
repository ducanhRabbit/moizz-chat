...
>(({ className,icon, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none h-6 w-6 rounded-full bg-paper shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-6 data-[state=unchecked]:translate-x-0 flex justify-center items-center"
      )}
